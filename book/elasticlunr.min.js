...
!(function () {
	function e(e) {
		...
		var t = e.constructor();
		for (var n in e) Object.hasOwn(e, n) && (t[n] = e[n]);
		return t;
	}
	var t = (e) => {
		var n = new t.Index();
	...
	(t.version = "0.9.5"),
		...
		(t.tokenizer = function (e) {
			...
			if (Array.isArray(e)) {
				var n = e.filter((e) => (null === e || void 0 === e ? !1 : !0));
				n = n.map((e) => t.utils.toString(e).toLowerCase());
				var i = [];
				return (
					n.forEach((e) => {
		...
		(t.tokenizer.setSeperator = (e) => {
			null !== e &&
				void 0 !== e &&
				"object" == typeof e &&
				(t.tokenizer.seperator = e);
		}),
		(t.tokenizer.resetSeperator = () => {
			t.tokenizer.seperator = t.tokenizer.defaultSeperator;
		}),
		(t.tokenizer.getSeperator = () => t.tokenizer.seperator),
		(t.Pipeline = function () {
			this._queue = [];
		}),
		(t.Pipeline.registeredFunctions = {}),
		(t.Pipeline.registerFunction = (e, n) => {
		...
		(t.Pipeline.getRegisteredFunction = (e) =>
			e in t.Pipeline.registeredFunctions != !0
				? null
		...
		(t.Index.prototype.idf = function (e, t) {
			var n = "@" + t + "/" + e;
			if (Object.hasOwn(this._idfCache, n)) return this._idfCache[n];
		...
		(t.Index.prototype.search = function (e, n) {
			...
			for (var p in l)
				(v = { ref: p, score: l[p] }),
					...
					g.push(v);
			return g.sort((e, t) => t.score - e.score), g;
		}),
		...
		(t.Index.prototype.mergeScores = (e, t, n) => {
			if (!e) return t;
			if ("AND" == n) {
				var i = {};
		...
		(t.Index.prototype.fieldSearchStats = (e, t, n) => {
			for (var i in n) i in e ? e[i].push(t) : (e[i] = [t]);
		}),
		(t.Index.prototype.coordNorm = (e, t, n) => {
			for (var i in e)
				if (i in t) {
					var o = t[i].length;
					e[i] = (e[i] * o) / n;
		...
		(t.stopWordFilter = (e) =>
			e && t.stopWordFilter.stopWords[e] !== !0 ? e : void 0),
		(t.clearStopWords = () => {
