...
- [AI Platform Overview](ai-platform-overview.md): High-level vision, navigation, and links to all major docs.
...
Stack Composer is evolving into a fully AI-guided, end-to-end project authoring and scaffolding platform. See [ai-wizard-roadmap.md](architecture-component-guides/ai-wizard-roadmap.md) for the full vision and phased implementation plan.
...
- Review [Component Details](component-details/readme.md)
